...
const fall2=[
  ...
  },
  {
    ...
    "updated_at": "2020-01-09T11:57:22Z",
  ...
  },
  {
    ...
    "updated_at": "2020-01-08T12:31:16Z",
  ...
  },
  {
    ...
    "updated_at": "2020-06-26T10:26:35Z",
...
const LeftSide= styled.div`
  ...
  login{
      font-size:16px;color:grey;margin-bottom:8px;margin-bottom:30px;
    } 
`
...
class App extends Component {
  ...
  render(){
    ...
    return <div>loading</div>;
      return <FullPage>
          <LeftSide>
            <div className="imagewrap"><img src={this.state.userData.avatar_url}/></div>
            <div className="name" >{this.state.userData.name}</div>
            <div  className="login" >{this.state.userData.login}</div>
            <div  style={{fontSize:'16px',color:'black'}}>{this.state.userData.bio}</div>
            <div  style={{lineHeight:'40px',margin:'10px 0',fontSize:'16px',color:'black',margin:'auto',backgroundColor:'white',height:'40px',width:'250px',border:'1px solid rgba(27,31,35,.15)',borderRadius:'4px'}}>{'follow'}</div>
            <div  style={{fontSize:'16px',color:'grey'}}>{this.state.userData.company}</div>
            <div  style={{fontSize:'16px',color:'grey'}}>{this.state.userData.email}</div>
          </LeftSide>
          <RightSide>
            <SearchDiv>
                <div style={{width:'55%'}}><input type="text" value={this.state.value||''} onChange={this.onChangeHandler.bind(this)} style={{width:'100%'}} placeholder={'Filter by language'}/></div>
                <div style={{width:'18%',backgroundColor:'#fafbfc',border:'1px solid black'}}>Type All</div>
                <div style={{width:'18%',backgroundColor:'#fafbfc',border:'1px solid black'}}>Language All</div>
            </SearchDiv>
            <div>{this.state.userRepo.map((repo,index) => {
              if(repo && repo.language && repo.language.toLowerCase().includes(this.state.value.toLowerCase()))
              return <div key={index}><RightSideRepo>
                <div style={{color:'#0366d6',fontSize:'20px',fontWeight:'bold'}}>{repo.name}</div>
